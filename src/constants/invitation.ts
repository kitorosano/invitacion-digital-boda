import {
  INVITATION_BANK_ACCOUNT_HOLDER,
  INVITATION_BANK_ACCOUNT_MESSAGE,
  INVITATION_BANK_ACCOUNT_NUMBER,
  INVITATION_BANK_ACCOUNT_TYPE,
  INVITATION_BANK_NAME,
...
export const bankAccountProps = {
  ...
  bankDetails: {
    bankName: INVITATION_BANK_NAME,
    accountType: INVITATION_BANK_ACCOUNT_TYPE,
    accountNumber: INVITATION_BANK_ACCOUNT_NUMBER,
    accountHolder: INVITATION_BANK_ACCOUNT_HOLDER,
  },
};
